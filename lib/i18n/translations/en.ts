...
export const en = {
  ...
  settings: {
    ...
    effects: 'Effects',
    style: 'Style',
    themeGeneratorApplied: 'Theme applied to store successfully',
    ...
    colorPrimaryHelper: 'Main brand color — buttons, links, highlights',
    colorSecondary: 'Secondary',
    colorSecondaryHelper: 'Supporting color — badges, tags, accents',
    ...
    effectsDescription: 'Choose how the background animates on your storefront',
  ...
  users: {
    ...
    studentsDescription: 'Browse all student accounts across your stores',
    teachersDescription: 'Manage teachers and their profiles',
    managersDescription: 'Review manager accounts and permissions',
    addUser: 'Add User',
    ...
    generalUsersNoRoles: 'General users without specific roles',
    users: 'Users',
    loadingUsersData: 'Loading users...',
    noUsersFound: 'No users found',
    getStartedByAddingUser: 'Get started by adding a new user.',
    id: 'ID',
  ...
  userDetails: {
    ...
    userNotFoundDescription: "The user you're looking for doesn't exist.",
    ...
    userInformationDescription: 'Detailed information about this user',
    profiles: 'Profiles',
    activity: 'Activity',
    settings: 'Settings',
    noProfiles: 'No profiles',
    noProfilesDescription: "This user doesn't have any profiles yet.",
    activityLog: 'Activity Log',
    activityLogDescription: 'User activity will be shown here.',
  ...
  userEdit: {
    title: 'Edit User',
    description: 'Update user data and role based on your permissions.',
    formTitle: 'User Information',
    formDescription: 'Edit profile data, status, and role.',
  ...
  financial: {
    store: {
      ...
      revenue: {
        ...
        roleBasedRevenue: 'Role-Based Revenue',
        roleBasedDescription: 'Revenue metric based on your role permissions',
        roleBasedAccess: 'Role Based Access',
        roleBasedAccessDescription:
          'Financial visibility is controlled by your role from the backend API',
        role: 'Role',
        platformRevenue: 'Platform Revenue',
        schoolRevenue: 'School Revenue',
        teacherRevenue: 'Teacher Revenue',
        teacher: 'Teacher',
        teacherRevenueBreakdown: 'Teacher Revenue Breakdown',
        teacherRevenueBreakdownDescription:
          'Revenue payout distribution for each teacher in this school',
        visibility: 'Visibility',
        showAmount: 'Show amount',
        hideAmount: 'Hide amount',
        visibilityUpdateFailed: 'Failed to update teacher visibility',
        hidden: 'Hidden',
        revenueHidden: 'Revenue Hidden',
        revenueHiddenDescription:
          'Your current role does not have revenue visibility. You can still manage operations data.',
        revenueHiddenPolicy: 'Revenue data is hidden by policy.',
