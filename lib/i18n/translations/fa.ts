...
export const fa = {
  ...
  settings: {
    ...
    themeGeneratorTitle: 'سازنده تم',
    themeGeneratorSubtitle: 'تم‌های خلاقانه برای مشتریان طراحی و تولید کنید.',
    copyConfig: 'کپی تنظیمات',
    copied: 'کپی شد!',
    applyToStore: 'اعمال روی فروشگاه',
    applying: 'در حال اعمال…',
    themeName: 'نام تم',
    themeNamePlaceholder: 'تم سفارشی من',
    ...
    effects: 'جلوه‌ها',
    style: 'سبک',
    themeGeneratorApplied: 'تم با موفقیت اعمال شد',
    presetsTitle: 'قالب‌های آماده',
    presetsDescription: 'از یک طراحی حرفه‌ای شروع کنید، سپس سفارشی‌سازی کنید',
    colorPaletteTitle: 'پالت رنگی',
    colorPaletteDescription: 'رنگ‌های مجزا برای حالت روشن و تاریک تنظیم کنید',
    darkModeLabel: 'حالت پیش‌فرض',
    lightMode: 'روشن',
    darkMode: 'تاریک',
    systemPreference: 'سیستم',
    colorPrimary: 'اصلی',
    colorPrimaryHelper: 'رنگ اصلی برند — دکمه‌ها، لینک‌ها، هایلایت‌ها',
    colorSecondary: 'ثانویه',
    colorSecondaryHelper: 'رنگ پشتیبان — برچسب‌ها، تگ‌ها',
    colorBackground: 'پس‌زمینه',
    colorBackgroundHelper: 'رنگ بوم صفحه',
    colorAccent: 'تاکیدی',
    colorAccentHelper: 'برچسب تخفیف، دکمه‌های فراخوان',
    quickPalettes: 'پالت‌های سریع',
    effectsTitle: 'جلوه‌های پس‌زمینه',
    effectsDescription: 'نحوه انیمیشن پس‌زمینه در فروشگاه را انتخاب کنید',
    svgPattern: 'الگوی SVG',
    styleTitle: 'سبک بصری',
    styleDescription: 'شعاع کنج، سایه و شدت انیمیشن المان‌ها را کنترل کنید',
    borderRadius: 'شعاع کنج',
    elementAnimation: 'انیمیشن المان‌ها',
    configSummary: 'خلاصه تنظیمات'
  },
  products: {
    title: 'محصولات',
    createProduct: 'ایجاد محصول',
  ...
  users: {
    ...
    studentsDescription: 'مرور همه حساب‌های دانش‌آموزان در آکادمی‌های شما',
    teachersDescription: 'مدیریت معلمان و پروفایل‌های آن‌ها',
    managersDescription: 'بررسی حساب‌ها و سطح دسترسی مدیران',
    addUser: 'افزودن کاربر',
    ...
    generalUsersNoRoles: 'کاربران عمومی بدون نقش خاص',
    users: 'کاربران',
    loadingUsersData: 'در حال بارگذاری کاربران...',
    noUsersFound: 'کاربری یافت نشد',
    getStartedByAddingUser: 'با افزودن یک کاربر جدید شروع کنید.',
    id: 'شناسه',
    createdAt: 'تاریخ ایجاد'
  },
  userDetails: {
    title: 'جزئیات کاربر',
    description: 'مشاهده و مدیریت اطلاعات کاربر',
    loadingUserDetails: 'در حال بارگذاری جزئیات کاربر...',
    failedToLoadUserDetails: 'بارگذاری جزئیات کاربر ناموفق بود',
    userNotFound: 'کاربر یافت نشد',
    userNotFoundDescription: 'کاربری که به دنبال آن هستید وجود ندارد.',
    ...
    userInformationDescription: 'اطلاعات کامل این کاربر',
    profiles: 'پروفایل‌ها',
    activity: 'فعالیت',
    settings: 'تنظیمات',
    noProfiles: 'پروفایلی وجود ندارد',
    noProfilesDescription: 'این کاربر هنوز هیچ پروفایلی ندارد.',
    activityLog: 'گزارش فعالیت',
    activityLogDescription: 'فعالیت‌های کاربر در اینجا نمایش داده می‌شود.',
  ...
  userEdit: {
    title: 'ویرایش کاربر',
    description: 'بر اساس دسترسی خود، اطلاعات و نقش کاربر را به‌روزرسانی کنید.',
    formTitle: 'اطلاعات کاربر',
    formDescription: 'اطلاعات پروفایل، وضعیت و نقش را ویرایش کنید.',
  ...
  admins: {
    ...
    tryAdjustingFilters: 'فیلترهای خود را تنظیم کنید.',
    getStartedByAdding: 'با افزودن یک کاربر ادمین جدید شروع کنید.',
    name: 'نام',
    email: 'ایمیل',
    phone: 'تلفن',
    status: 'وضعیت',
  ...
  createAdminUser: {
    ...
    verify: 'تأیید',
    verified: 'تأیید شده',
    enterPhoneOtp: 'کد OTP تلفن را وارد کنید',
    enterEmailOtp: 'کد OTP ایمیل را وارد کنید',
    createAdminUser: 'ایجاد کاربر ادمین',
    phoneOtpSent: 'OTP به شماره تلفن ارسال شد',
    emailOtpSent: 'OTP به ایمیل ارسال شد',
    phoneOtpVerified: 'OTP تلفن تأیید شد',
    emailOtpVerified: 'OTP ایمیل تأیید شد',
    phoneNumberRequired: 'شماره تلفن الزامی است',
    emailRequired: 'ایمیل الزامی است',
    pleaseEnterPhoneOtp: 'لطفاً کد OTP تلفن را وارد کنید',
  ...
  changeUserRole: {
    ...
    description: 'نقش این دانش‌آموز را به معلم یا مدیر تغییر دهید.',
    onlyStudentsCanChange: 'فقط دانش‌آموزان می‌توانند نقش خود را تغییر دهند.',
    currentRole: 'نقش فعلی',
    newRole: 'نقش جدید',
    noRole: 'بدون نقش',
  ...
  financial: {
    store: {
      ...
      revenue: {
        ...
        roleBasedRevenue: 'درآمد مبتنی بر نقش',
        roleBasedDescription: 'شاخص درآمد بر اساس سطح دسترسی نقش شما',
        roleBasedAccess: 'دسترسی مبتنی بر نقش',
        roleBasedAccessDescription:
          'نمایش اطلاعات مالی بر اساس نقش شما از طریق API بک‌اند کنترل می‌شود',
        role: 'نقش',
        platformRevenue: 'درآمد پلتفرم',
        schoolRevenue: 'درآمد آکادمی',
        ...
        visibilityUpdateFailed: 'به‌روزرسانی نمایش درآمد مدرس ناموفق بود',
        hidden: 'مخفی',
        revenueHidden: 'درآمد مخفی است',
        revenueHiddenDescription:
          'نقش فعلی شما دسترسی مشاهده درآمد ندارد. همچنان می‌توانید داده‌های عملیاتی را مدیریت کنید.',
        revenueHiddenPolicy: 'طبق سیاست، داده‌های درآمد مخفی است.',
        unknownStudent: 'نامشخص',
    ...
    platform: {
      ...
      loading: 'در حال بارگذاری اطلاعات مالی...',
      loadFailed: 'بارگذاری اطلاعات مالی پلتفرم ناموفق بود',
      filters: 'فیلترها',
      year: 'سال',
      month: 'ماه (اختیاری)',
      allMonths: 'همه ماه‌ها',
      ...
      iranSettlementTitle: 'خلاصه تسویه ایران',
      iranSettlementDescription: 'مجموع تسویه PayPing برای بازه انتخابی',
      gross: 'خالص فروش',
      platformFee: 'کارمزد پلتفرم',
