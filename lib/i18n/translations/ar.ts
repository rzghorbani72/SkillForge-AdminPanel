...
export const ar = {
  ...
  navigation: {
    ...
    'platform-pricing': 'تسعير المنصة',
    'pricing-cms': 'إدارة التسعير',
  ...
  settings: {
    ...
    pricingCmsTitle: 'إدارة محتوى التسعير',
    ...
    themeGeneratorTitle: 'مولد المظهر',
    themeGeneratorSubtitle: 'صمّم وأنشئ مظاهر إبداعية لعملائك.',
    copyConfig: 'نسخ الإعدادات',
    copied: 'تم النسخ!',
    applyToStore: 'تطبيق على المتجر',
    applying: 'جارٍ التطبيق…',
    themeName: 'اسم المظهر',
    themeNamePlaceholder: 'مظهري المخصص',
    ...
    effects: 'التأثيرات',
    style: 'الأسلوب',
    themeGeneratorApplied: 'تم تطبيق المظهر على المتجر بنجاح',
    presetsTitle: 'قوالب الألوان الجاهزة',
    presetsDescription: 'ابدأ من قالب مصمم باحترافية، ثم خصصه',
    colorPaletteTitle: 'لوحة الألوان',
    colorPaletteDescription: 'اضبط ألوانًا مختلفة للوضعين الفاتح والداكن',
    darkModeLabel: 'الوضع الافتراضي',
    lightMode: 'فاتح',
    darkMode: 'داكن',
    systemPreference: 'النظام',
    colorPrimary: 'الرئيسي',
    colorPrimaryHelper: 'لون العلامة التجارية — الأزرار، الروابط، الإبرازات',
    colorSecondary: 'الثانوي',
    colorSecondaryHelper: 'لون مساعد — الشارات، العلامات',
    colorBackground: 'الخلفية',
    colorBackgroundHelper: 'لون لوحة الصفحة خلف المحتوى',
    colorAccent: 'التمييز',
    colorAccentHelper: 'ملصقات الخصم، أزرار الحث على الإجراء',
    quickPalettes: 'لوحات سريعة',
    effectsTitle: 'تأثيرات الخلفية',
    effectsDescription: 'اختر كيفية تحريك الخلفية في واجهة متجرك',
    svgPattern: 'نمط SVG',
    styleTitle: 'الأسلوب البصري',
  ...
  financial: {
    store: {
      ...
      revenue: {
        ...
        roleBasedRevenue: 'إيراد حسب الدور',
        roleBasedDescription: 'يتم عرض مؤشر الإيراد وفق صلاحيات دورك',
        roleBasedAccess: 'الوصول حسب الدور',
        roleBasedAccessDescription:
          'يتم التحكم في عرض البيانات المالية حسب دورك من خلال واجهة API الخلفية',
        role: 'الدور',
        platformRevenue: 'إيراد المنصة',
        schoolRevenue: 'إيراد المتجر',
        ...
        visibilityUpdateFailed: 'فشل تحديث عرض إيراد المدرس',
        hidden: 'مخفي',
        revenueHidden: 'الإيراد مخفي',
        revenueHiddenDescription:
          'دورك الحالي لا يملك صلاحية عرض الإيراد. لا يزال بإمكانك إدارة بيانات التشغيل.',
        revenueHiddenPolicy: 'تم إخفاء بيانات الإيراد حسب السياسة.',
