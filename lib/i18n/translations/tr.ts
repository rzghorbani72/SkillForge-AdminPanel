...
export const tr = {
  ...
  settings: {
    ...
    themeName: 'Tema Adı',
    themeNamePlaceholder: 'Özel Temam',
    ...
    lightMode: 'Açık',
    darkMode: 'Koyu',
    systemPreference: 'Sistem',
    colorPrimary: 'Birincil',
    colorPrimaryHelper: 'Ana marka rengi — düğmeler, bağlantılar, vurgular',
    colorSecondary: 'İkincil',
    colorSecondaryHelper: 'Destekleyici renk — rozetler, etiketler',
    colorBackground: 'Arka Plan',
    colorBackgroundHelper: 'Tüm içeriğin arkasındaki sayfa tuvali rengi',
    colorAccent: 'Vurgu',
    colorAccentHelper: 'İndirim etiketleri, harekete geçirme vurguları',
    quickPalettes: 'Hızlı Paletler',
    effectsTitle: 'Arka Plan Efektleri',
  ...
  financial: {
    store: {
      ...
      revenue: {
        ...
        roleBasedRevenue: 'Role Bazlı Gelir',
        roleBasedDescription: 'Gelir metriği rol izinlerinize göre gösterilir',
        roleBasedAccess: 'Role Bazlı Erişim',
        roleBasedAccessDescription:
          'Finansal görünürlük, backend API tarafından rolünüze göre kontrol edilir',
        role: 'Rol',
        platformRevenue: 'Platform Geliri',
        schoolRevenue: 'Mağaza Geliri',
        ...
        visibilityUpdateFailed: 'Eğitmen gelir görünürlüğü güncellenemedi',
        hidden: 'Gizli',
        revenueHidden: 'Gelir Gizli',
        revenueHiddenDescription:
          'Mevcut rolünüz gelir görüntüleme yetkisine sahip değil. Operasyonel verileri yine de yönetebilirsiniz.',
        revenueHiddenPolicy: 'Gelir verileri politika gereği gizlidir.',
        unknownStudent: 'Bilinmiyor',
        unknownCourse: 'Bilinmeyen Kurs',
