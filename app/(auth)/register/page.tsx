...
import { Eye, EyeOff, Mail, Phone, Lock, School, Loader2, AlertCircle, User, Building } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const [registrationType, setRegistrationType] = useState<'new-school' | 'existing-school'>('new-school');
  ...
  const validateForm = () => {
    ...
    if (registrationType === 'new-school') {
      ...
      if (!formData.schoolSlug.trim()) {
        ...
        newErrors.schoolSlug = 'School slug can only contain lowercase letters, numbers, and hyphens';
      }
    } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
      <div className="w-full max-w-2xl">
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            This registration is for <strong>Teachers and Administrators</strong> only. 
            Students should register through their school's website.
          </AlertDescription>
        </Alert>
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Start your own educational institution</p>
                      </div>
                    </div>
                  </div>
                  <div
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Join as a teacher at an existing school</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      This will be your school's unique URL: {formData.schoolSlug || 'your-school'}.skillforge.com
                    </p>
                    {errors.schoolSlug && (
                      <p className="text-sm text-red-500">{errors.schoolSlug}</p>
                    )}
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="schoolDescription">School Description (Optional)</Label>
                    <Textarea
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) => handleInputChange('existingSchoolId', value)}
                      disabled={isLoading}
                    >
                      <SelectTrigger className={errors.existingSchoolId ? 'border-red-500' : ''}>
                        <SelectValue placeholder="Choose a school to join" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="school1">Harvard University</SelectItem>
                        <SelectItem value="school2">MIT</SelectItem>
                        <SelectItem value="school3">Stanford University</SelectItem>
                        <SelectItem value="school4">Yale University</SelectItem>
                      </SelectContent>
                    </Select>
                    {errors.existingSchoolId && (
                      <p className="text-sm text-red-500">{errors.existingSchoolId}</p>
                    )}
                  </div>
                </div>
              )}
