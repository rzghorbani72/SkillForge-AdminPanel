...
const STAGE_OPTIONS: Array<{ label: string; value: StageFilter }> = [
  { label: 'All progress levels', value: 'all' },
  { label: 'On track (50-99%)', value: 'on-track' },
  { label: 'Lagging (< 50%)', value: 'lagging' },
  { label: 'Completed', value: 'completed' }
];
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Pinpoint students who need attention, track completions, and keep an
            eye on overall learning velocity.
          </p>
        </div>
        <div className="grid gap-2 text-right">
          <span className="text-sm text-muted-foreground">
            Average progress across current view
          </span>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Learners who reached 100% in the selected view
            </p>
          </CardContent>
        </Card>
        <Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-muted-foreground">
              Showing {filteredEnrollments.length} enrolments on this page
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            {isLoading ? (
              ...
              <div className="flex h-56 flex-col items-center justify-center text-center">
                <p className="text-sm font-medium">
                  No progress data for the selected filters.
                </p>
                <p className="mt-1 text-sm text-muted-foreground">
                  Try adjusting the status or progress level filters to widen
                  the scope.
                </p>
              </div>
            ) : (
